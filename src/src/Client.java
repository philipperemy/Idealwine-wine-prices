...
public class Client {
	...
	public static WebClient getIdealwineBrowserClient()
		...
		final HtmlPage homePage = client
				.getPage("http://www.idealwine.com/fr/home/index_home.jsp");
	...
	public static HtmlPage getHtmlPage(WebClient client, String wineName,
			String millesime, String size) throws FailingHttpStatusCodeException, MalformedURLException, IOException {

		return client.getPage(URLMaker.create(wineName,
				millesime, size));
